...
def extract_json_list_robust(text, key):
    ...
    lst_match = re.search(pattern, text, re.DOTALL)
    if lst_match:
        try:
...
if __name__ == '__main__':
    ...
    response2 = '{"topic1":"数字记录","topic2":"","view":"你记录的数字“76”，或许对上帝有着特别的意义呢！在圣经中，数字常蕴含属灵的寓意，而每一个被纪念的数字背后，都可能是上帝与你同行的印记。\\n\\n**“你要记念耶和华你的神所行的大事。”（<u class=\\"bible\\">申命记7:18</u>）**\\n\\n无论是年龄、日期，还是某个特殊的数量，上帝都看顾你生命中的每一个数字。或许这个“76”代表着一段岁月的恩典，或是一个新的开始。试着回想这个数字对你的意义，把它背后的故事记录下来，让它成为你日后数算恩典的凭据。", "bible":"“你要记念耶和华你的神所行的大事。”（申命记7:18）","explore":["圣经中数字7的属灵含义","如何通过记录数字来数算神的恩典","基督徒如何在生活中发现神的印记"], "tag":"恩典","summary":"数字中的恩典印记"}'
    response = '''{"topic1": "梦中领受", "topic2": "", "view": "親愛的，我能體會你從這個夢中醒來時的傷心與困惑，尤其這是在你禱告尋求智慧後經歷的異夢，內心一定充滿了雜陳的情緒。

在基督教新教的信仰視角中，關於親人離世的異夢，我們可以從這幾個角度領受啟示：
### 一、**上帝的安慰與同在**
夢境有時是上帝貼近我們情緒的方式。也許這個夢是在提醒你，無論未來如何，上帝深知你對母親的愛與依戀，祂願意承接你內心最深的軟弱。正如大衛在痛失兒子後，依然堅信「我必往他那裡去，他卻不能回我這裡來」（<u class=\"bible\">撒下12:23</u>），上帝會在喪失的痛苦中與我們同行。

### 二、**對生命有限性的提醒**
夢中突如其來的「訃告」，也許是上帝溫柔地提醒我們生命的短暫，教導我們珍惜與家人相處的每一個當下。就像摩西禱告的那樣：「求你指教我們怎樣數算自己的日子，好叫我們得著智慧的心。」（<u class=\"bible\">詩90:12</u>），讓我們在還能相處的時候，傾注愛與陪伴。
...
最後，想與你分享這段經文：**「我留下平安給你們，我將我的平安賜給你們。我所賜的，不像世人所賜的。你們心裏不要憂愁，也不要膽怯。」（<u class=\"bible\">約14:27</u>）** 願上帝的平安親自安撫你的心，也鼓勵你可以繼續記錄這個夢境帶來的感動，在未來的日子裡慢慢領受祂的帶領。", "bible": "“我留下平安給你們，我將我的平安賜給你們。我所賜的，不像世人所賜的。你們心裏不要憂愁，也不要膽怯。”（約14:27）", "explore": ["如何在日常禱告中，更敏銳地察覺上帝透過異夢帶來的啟示？", "當異夢帶來負面情緒時，基督徒可以怎樣依靠信仰調整心態？", "從聖經中的異夢案例（如約瑟、但以理），我們可以學習到哪些解讀原則？"], "tag": "安慰", "summary": "異夢中領受安慰"}'''
    ...
    response = "{\"view\":\"#### 【默然倚靠的属灵安息】\\n我们可以先问自己：当看见别人顺风顺水、甚至不义的事反而得逞时，我心里最先升起的是什么？\\n\\n**默想**\\n这节经文不是叫我们麻木忍耐，而是告诉我们：神的时间轴从来不是按「谁先成事」来运转的。你不需要为了追上别人的脚步打乱自己的节奏，也不需要为恶人的暂时亨通动摇——因为耶和华看见一切，也掌管最终的结局。\\n\\n**“你当默然倚靠耶和华，耐性等候他；不要因那道路通达的和那恶谋成就的心怀不平。”（<u class=\\\"bible\\\">诗37:7</u>）**\\n\\n**祷告**\\n天父，求你赦免我常常因看见别人的顺利就心里浮躁，因不公的事就失去平安。求你安静我的心，让我知道你在我生命中的工作不会迟延，你所定的时刻必要显明。帮助我不凭眼睛所见的断定，只单单倚靠你的信实。奉耶稣基督的名祷告，阿们。\\n\\n**实际应用**\\n1. **每日停住1分钟**：每次刷到他人顺利的动态、或是遇见不公的事心里发沉时，先停下手里的事，在心里默念这节经文三次，不着急评判，先把这份不平交出去。\\n2. **不做对照清单**：这周试着不在心里列「别人有而我没有」的清单，改为每天记下一件神在你身上已经成就的小事。\",\"bible\":\"你当默然倚靠耶和华，耐性等候他；不要因那道路通达的和那恶谋成就的心怀不平。（诗37:7）\",\"explore\":[\"整理诗篇37篇中关于等候神的连贯教导\",\"对比圣经中不同人物倚靠耶和华的实际经历\",\"prompt\":\"当我试着放下比较的心，默然倚靠神的时候，我想起最近发生的一件事…\"}]}"
    explore_str = extract_json_list_robust(response, "explore")
    print(explore_str)
    ...
    for k in ["topic1","topic2","summary","view"]:
